...
parser.add_argument('--data', dest='dataset', default='fb15k',
                    help='Dataset to use, default: fb15k')
parser.add_argument('--init_dim', dest='init_dim', default=50, type=int,
                    help='Initial dimension size for entities and relations')
parser.add_argument('--gcn_dim', dest='gcn_dim', default=50,
                    type=int, help='Number of hidden units in GCN')
parser.add_argument('--errorrate', dest='errorrate', default='10',
                    type=str, help='error rate of training')
parser.add_argument('--comprehensive', dest='comprehensive', default='1',
                    type=str, help='error rate of training')

parser.add_argument('--epoch', dest='max_epochs',
                    type=int, default=16, help='Number of epochs')
parser.add_argument('--lamda', dest='lamda',
                    type=float, default=0.4, help='rate between two loss')
...
parser.add_argument('--noltr', action='store_true',
                    default=False, help='no use of linear transformations for relation outputs')
